...
class TermsAndConditionsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
""", "If you have any questions about these Terms, please contact us at info@fm2app.com ."]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "aboutUsCell", for: indexPath) as? AboutFMCell {
